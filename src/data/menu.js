...
export const portfolioItems = [
  { name: "Liquidaciones de compra.", link: "#liquidacion-compras" },
  {
    name: "Sistema web de guías de transportistas.",
    link: "#guias-transportistas",
  },
  {
    name: "Sistema web de guías de remisión.",
    link: "#guias-remision",
  },
];

export const blogItems = [
  { link: "#sistema-estandar", text: "Sistema Estándar" },
  { link: "#sistema-medida", text: "Sistema a medida" },
];
